...
// OUTPUT:
// c502@22D50219:~$ gedit deffiehellman.c
// ^C
// c502@22D50219:~$ gcc deffiehellman.c -lm
// c502@22D50219:~$ ./a.out
// Enter a Prime Number "q":11
// Enter a No "xa" which is less than value of q:8
// Enter a No "xb" which is less than value of q:4
// alpha = 2
// ya = 3
// yb = 5
// ka = 4
// kb = 4
// The keys exchanged are samec502@22D50219:~$